programa
{
	...
	funcao inicio()
	{
		 ...
		 * o índice de poluição mantém 3 grupos de indústrias 
		 * que são altamente poluentes do meio ambiente. 
		 * O índice de poluição aceitável varia de 0,05 até 0,25. 
		 * Se o índice sobe para 0,3 as indústrias do 
		 * 1º grupo são intimadas a suspenderem suas atividades, 
		 * se o índice crescer para 0,4 as industrias do 1º e 2º 
		 * grupo são intimadas a suspenderem suas atividades, 
		 ...
		 * e emita a notificação adequada aos diferentes 
		 * grupos de empresas.
		 * 
		 */
		//variaveis
		real indice
		//entradas
		escreva("Digite o indice poluição do momento :")
		leia(indice)
		//processamentos
		se (indice <=0.25){
			escreva("Tudo bem, segue o jogo!!")
		}
		senao se (indice <0.3){
			escreva("Não definido...segue o jogo!!")
		}
		...
		senao {
			escreva("EMPRESAS - PAREM SUAS ATIVIDADES!!!")
		}
		//saidas
